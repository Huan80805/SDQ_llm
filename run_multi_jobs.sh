...
jobs=(
    "job_1::CUDA_VISIBLE_DEVICES=0 python greedy_search.py -m checkpoints/spnet/step_1000 -sf analysis/sensitivity_spnet.json -o analysis/greedy_search_spnet.jsonl"
    "job_2::CUDA_VISIBLE_DEVICES=1 python greedy_search.py -m checkpoints/instantnet/step_1000 -sf analysis/sensitivity_instantnet.json -o analysis/greedy_search_instantnet.jsonl"
    "job_3::CUDA_VISIBLE_DEVICES=3 python greedy_search.py -m checkpoints/instantnet_kd/step_1000 -sf analysis/sensitivity_instantnet_kd.json -o analysis/greedy_search_instantnet_kd.jsonl"
    "job_4::CUDA_VISIBLE_DEVICES=3 python greedy_search.py -m checkpoints/cyclic/step_1000 -sf analysis/sensitivity_cyclic.json -o analysis/greedy_search_cyclic.jsonl"
)
